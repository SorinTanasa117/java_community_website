        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          ...
          <div className={`${
            ...
            <Button
              onClick={handleCollapse}
              variant="outline"
              className="bg-white text-primary justify-center border-2 border-primary px-8 py-3 rounded-lg hover:bg-primary hover:text-white transition-colors duration-200"
            >
              View All Services
            </Button>
          </div>
